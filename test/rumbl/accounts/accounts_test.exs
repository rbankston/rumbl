defmodule Rumbl.AccountsTest do
  ...
  describe "credentials" do
    ...
    @valid_attrs %{email: "some email", pasword_hash: "some pasword_hash"}
    @update_attrs %{email: "some updated email", pasword_hash: "some updated pasword_hash"}
    @invalid_attrs %{email: nil, pasword_hash: nil}
    ...
    test "create_credential/1 with valid data creates a credential" do
      ...
      assert credential.pasword_hash == "some pasword_hash"
    end
    ...
    test "update_credential/2 with valid data updates the credential" do
      ...
      assert credential.pasword_hash == "some updated pasword_hash"
    end
